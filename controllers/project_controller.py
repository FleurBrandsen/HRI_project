            ...
            while self.step(self.timeStep) != -1:
                ...
                if m["m00"] != 0:
                    ...
                    if not found:
                        ...
                        if cx == cutoff and cy == cutoff:
                            ...
                            self.head_horizontal.setVelocity(0.15)
                            self.turn_to_can(cx, turn_speed = x_speed)
                            #break
                
                    if found:
                        test = self.turn_to_can(cx)   
                        print(self.horizontal_sensor.getValue())                     
                        if 240 < cx < 260 and -0.1 < self.horizontal_sensor.getValue() < 0.1:
                ...
                #Searching for the colour
                    ...
                    if checked < 6:
                        ...
                        break
                    checked += self.move_joint(joint, position, input)
